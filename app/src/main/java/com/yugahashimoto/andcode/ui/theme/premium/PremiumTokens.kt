...
object PremiumTokens {
    ...
    fun tweenFast(delayMs: Int = 0) =
        tween<Float>(durationMillis = DurationFast, delayMillis = delayMs, easing = EasingDecelerate)

    fun tweenMedium(delayMs: Int = 0) =
        tween<Float>(durationMillis = DurationMedium, delayMillis = delayMs, easing = EasingEmphasized)

    fun tweenSlow(delayMs: Int = 0) =
        tween<Float>(durationMillis = DurationSlow, delayMillis = delayMs, easing = EasingDecelerate)
