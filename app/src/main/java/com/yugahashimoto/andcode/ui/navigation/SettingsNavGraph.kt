...
fun NavGraphBuilder.settingsNavGraph(
    ...
    composable(ROUTE_SETTINGS) {
        ...
        SettingsScreenV2(
            ...
            onOpenMissions = { navController.navigate(ROUTE_MISSIONS) },
            onOpenBuildLab = { navController.navigate(ROUTE_BUILD_LAB) },
            onOpenPerformanceMonitor = { navController.navigate(ROUTE_PERFORMANCE_MONITOR) },
            onOpenAiTeamSettings = { navController.navigate(ROUTE_AI_TEAM_SETTINGS) },
            onOpenModelRouter = { navController.navigate(ROUTE_MODEL_ROUTER) },
            onOpenProjectIndex = { navController.navigate(ROUTE_PROJECT_INDEX) },
            onOpenBuildDoctor = { navController.navigate(ROUTE_BUILD_DOCTOR) },
            onOpenAdvancedGit = { navController.navigate(ROUTE_ADVANCED_GIT) },
